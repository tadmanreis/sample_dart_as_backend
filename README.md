# Sample dart as Backend

in this example we create a simple RPG helper with dice and generate names
...
```shell
$ curl http://localhost:8080/dice/roll/6
{"number":2}
```
...
```shell
$ curl http://localhost:8080/name/generate
{"name":"Pulchi"}
```
Generate a name by given start letters

```shell
$ curl http://localhost:8080/name/filter/aa
{"names":["Aaberg","Aalst","Aara","Aaren","Aarika","Aaron","Aaronson"]}
```
